        ...
        <div style={{ maxWidth: 420 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem", marginBottom: "1.5rem" }}>
            {[
              ...
              "PDF Intelligence — structure & summarize",
              "Document Q&A — ask questions, get answers",
              "Export to Word — one-click conversion",
            ].map((feature) => (
              <div key={feature} style={{ display: "flex", alignItems: "center", gap: 10, color: "rgba(255,255,255,0.65)", fontSize: "0.88rem" }}>
